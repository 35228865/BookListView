...
namespace BookListView
{
    public partial class frmBooks : Form
    {
        ...
        private void frmBooks_Load(object sender, EventArgs e)
        {
            ...
            this.Font = new Font("微軟正黑體", 11f, FontStyle.Bold); 

            grpView.ForeColor = Color.FromArgb(212, 175, 55);

            grpBorrow.ForeColor = Color.FromArgb(212, 175, 55);

            lvwBooks.BackColor = Color.FromArgb(45, 41, 42); 
            lvwBooks.ForeColor = Color.FromArgb(230, 230, 230); 
            lvwBooks.BorderStyle = BorderStyle.None;
            lvwBooks.FullRowSelect = true;


            lstBorrow.BackColor = Color.FromArgb(45, 41, 42);
            lstBorrow.ForeColor = Color.FromArgb(100, 255, 100); 
            lstBorrow.BorderStyle = BorderStyle.None;

            cmbView.DropDownStyle = ComboBoxStyle.DropDownList;
            cmbView.BackColor = Color.FromArgb(60, 56, 57);
            cmbView.ForeColor = Color.White;
